...
Contract scope: ForgeKit application `0.1.1`; manifest `forgekit.plugin/v1`; UI `forgekit.ui/v1`; wire protocol `forgekit/1`; runtime capabilities `forgekit.runtime/v1`.
